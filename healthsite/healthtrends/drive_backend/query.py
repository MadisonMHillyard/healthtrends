...
class Query():
    ...
    def __init__(self, terms: str, geo: str, freq: str, start_date: str,
                 end_date: str, num_runs: int, health_service):
        """
    ...
    def query_healthcare_api(self, start_date: str, end_date: str):
        tfh = self.health_service.getTimelinesForHealth(terms=self.terms,
